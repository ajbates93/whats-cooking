  ...
  <div class="px-5">
    ...
    <div class="my-5">
      <div class="text-xl text-gray-600">
        Edit profile details, add family members to your Household, link your social
        accounts.
      </div>
    </div>
    <h2 class="text-gray-600 flex items-center">
      <span>Your profile</span>
      <Icon class="ml-5 text-primary" name="carbon:user" />
    </h2>
    <form
    ...
    >
      ...
      <div>
        ...
        <input id="username" v-model="username" type="text" class="py-1 px-2 border rounded">
      </div>
      <div>
    ...
    <h2 class="text-gray-600 flex items-center">
      ...
      <Icon class="ml-5 text-primary" name="carbon:home" />
    </h2>
    <div class="my-5">
